...
function renderTerms() {
  ...
  container.innerHTML = `
    <div>
      ...
      <p class="mt-2" data-i18n="services.terms.delivery.content">交付周期（如"最快10天"）指我方交付首个完整预览版本（V1）所需的最短工作时间。此周期的起算点为客户方提供了所有必要的、符合要求的资料（包括但不限于最终文案、图片、Logo、及明确的需求文档）之后。因客户方资料延迟或中途提出新需求导致的时间延长，不在此承诺时限内。</p>
    </div>
    <div>
