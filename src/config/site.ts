...
export const DEFAULT_DESCRIPTION =
  'Pop Up Limited specializes in product management, UI/UX design, iOS development, and digital marketing. We provide professional website development services.';
